...
marking = pd.read_csv(r'/home/huazai/projects/kaggle_wheat/data/train.csv')
...
#             A.RandomSizedCrop(min_max_height=(800, 800), height=1024, width=1024, p=0.5),
#             A.OneOf([
#                 A.HueSaturationValue(hue_shift_limit=0.3, sat_shift_limit= 0.4,
...
TRAIN_ROOT_PATH = r'/home/huazai/projects/kaggle_wheat/data/train'
...
def get_net():
    ...
    checkpoint = torch.load(r'/home/huazai/projects/kaggle_wheat/efficientdet-pytorch-master/effdet5-cutmix-augmix3/last-checkpoint.bin')
